      ...
      <div className="bg-slate-50 border-t border-slate-100 px-5 py-4 md:px-6 space-y-3.5 mt-1">
        ...
        <div className="flex flex-col gap-2">
          ...
          <a
            ...
            className="bg-emerald-600 hover:bg-emerald-700 text-white py-2.5 px-4 rounded-xl flex items-center justify-center gap-2 transition-all shadow-xs font-black text-[10.5px] uppercase cursor-pointer w-full text-center"
          >
